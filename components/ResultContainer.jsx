            ...
            <div className="flex justify-center h-full">
                <div className="text-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-600">This person has already been checked in!</p>
                    </div>
            ...
            <div className="flex justify-center h-full">
                <div className="text-center">
                    ...
                    <div>
                        ...
                        {!checkedIn ? (
                            <button className="btn !bg-green-500 mt-5" onClick={handleCheckin} disabled={isLoading}>
                                {isLoading ? (
                            ...
                            <button className="btn !bg-green-500 mt-5">
                                <div className="flex justify-center" role="status">
