      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="h-10 w-full sm:w-36 bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
            <div className="h-10 w-full sm:w-32 bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
            <div className="h-10 w-full sm:w-24 bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
            <div className="h-10 w-full sm:w-24 bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
          </div>
        </div>
      </div>
